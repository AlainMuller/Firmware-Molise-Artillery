...
#define TOUCH_MI_PROBE                            //uncomment if you use a Touch Mi
    ...
    #define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN
    #define Z_MIN_PROBE_REPEATABILITY_TEST
    #define NOZZLE_TO_PROBE_OFFSET { -40, -30, 0 }  // Offset preset for official hotends.fr support (here https://drive.google.com/file/d/1vxzbx5Q2CRGgHi0zroxD_QCnduqm1Euh/view?usp=sharing)
